...
public class Deck4 extends Ships {
    /*private int [] deck4 - массив чисел, передаваемых в конструктор при создании объекта Deck4 в классе Main,
    * содержит числа 411, 412, 413, 414. Эти числа выступают в качестве value в массиве battlefield для определения
    * четырехпалубного корабля
    *
    * private int limitDeck4 - число, передаваемое в конструктор при создании объекта Deck4 в классе Main,
    * содержит число 41. Это число - выступает в качестве value в массиве battlefield для определения границы
    * четырехпалубного корабля
    */
    ...
    */
    ...
    /* _(1-14)LimitCoordHor ( _(1-14)LimitCoordVer ) - (1-я - 14-я) координата границы корабля для случая
    ...
    */
     ...
     * для определения буквы (координата состоит из буквы и цифры) первой (второй, третьей, четверной соответственно)
     * координаты четырехпалубного корабля по горизонтали
     *
     * private randomNumberForNumberHor - случайное число (координата состоит из буквы и цифры)
     * первой, второй, третьей и четверной соответственно координаты четырехпалубного корабля по горизонтали.
     * Не забываем, корабль находить по горизонтали, поэтому число одно, а буквы 4.
     */
     ...
     * первой (второй, третьей, четверной соответственно) координаты четырехпалубного корабля по вертикали
     *
     * private randomNumberForLetterVer - случайное число (в последствии будет преобразованно в букву)для
     * определения буквы (координата состоит из буквы и цифры) первой координаты четырехпалубного корабля по вертикали
    ...
    /*
    * private String firstCoordinateHor (secondCoordinateHor, thirdCoordinateHor, fourthCoordinateHor ) - координаты
    * четырехпалубного корабля по горизонтали (например A1, B1, C1, D1)
    *
    * private String firstCoordinateVer (secondCoordinateVer, thirdCoordinateVer, fourthCoordinateVer ) - координаты
    * четырехпалубного корабля по вертикали (например A1, A2, A3, A4)
    */
    ...
    // МЕТОД, который устанавливает координаты 4-х палубного корабля
    public Map<String, Integer> genCoordDeck4(Map battlefield) {
        ...
        switch (verOrHorPositionOfSpips) {
            case 0:
                //выбираем случайное число для первой буквы и генерируем еще з числа. Это будут буквы координат 4-х палубного корабля
                ...
                // добавляем их в массив для генерации границ корабля
                ...
                // добавляем его в массив для генерации границ корабля
                ...
                /* добавляем в массив battlefield наш корабль, ему соответствуют числа 411, 412, 413, 414.
    ...
    // МЕТОД, который устанавливает координаты границ 4-х палубного корабля
